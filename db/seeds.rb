...
film.scripts.create(quote: "Where we're going, we don't need roads.", character: "Dr. Emmett Brown", show: "Back to the Future")
film.scripts.create(quote: "Oh, no, it wasn't the airplanes. It was Beauty killed the Beast.", character: "Carl Denham", show: "King Kong")
film.scripts.create(quote: "Your scientists were so preoccupied with whether or not they could that they didn't stop to think if they should.", character: "Dr. Ian Malcolm", show: "Jurassic Park")
film.scripts.create(quote: "Snakes. Why'd it have to be snakes?", character: "Indiana Jones", show: "Raiders of the Lost Ark")
film.scripts.create(quote: "Life moves pretty fast. If you don't stop and look around once in a while, you could miss it.", character: "Ferris Bueller", show: "Ferris Bueller's Day Off")
film.scripts.create(quote: "Get busy living, or get busy dying.", character: "Andy Dufresne", show: "The Shawshank Redemption")
film.scripts.create(quote: "The greatest trick the Devil ever pulled was convincing the world he didn't exist.", character: "Roger 'Verbal' Kint", show: "The Usual Suspects")
film.scripts.create(quote: "They may take our lives, but they'll never take our freedom!", character: "William Wallace", show: "Braveheart")
film.scripts.create(quote: "There’s no crying in baseball!", character: "Jimmy Dugan", show: "A League of Their Own")
film.scripts.create(quote: "The seaweed is always greener in somebody else’s lake.", character: "Sebastian", show: "The Little Mermaid")
film.scripts.create(quote: "If I could only have one food for the rest of my life? That's easy-Pez. Cherry-flavored Pez. No question about it.", character: "Vern", show: "Stand By Me")
film.scripts.create(quote: "Do you have some sort of business woman special?", character: "Romy White", show: "Romy and Michele's High School Reunion")
